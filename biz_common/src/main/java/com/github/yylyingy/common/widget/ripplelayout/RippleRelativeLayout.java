...
public class RippleRelativeLayout extends RelativeLayout {
    ...
    private void init(final Context context, final AttributeSet attrs) {
        ...
        rippleColor = typedArray.getColor(R.styleable.RippleRelativeLayout_ripple_color, getResources().getColor(R.color.rippelColor));
        rippleType = typedArray.getInt(R.styleable.RippleRelativeLayout_ripple_type, 0);
        hasToZoom = typedArray.getBoolean(R.styleable.RippleRelativeLayout_ripple_zoom, false);
        isCentered = typedArray.getBoolean(R.styleable.RippleRelativeLayout_ripple_centered, false);
        rippleDuration = typedArray.getInteger(R.styleable.RippleRelativeLayout_ripple_rippleDuration, rippleDuration);
        frameRate = typedArray.getInteger(R.styleable.RippleRelativeLayout_ripple_framerate, frameRate);
        rippleAlpha = typedArray.getInteger(R.styleable.RippleRelativeLayout_ripple_alpha, rippleAlpha);
        ripplePadding = typedArray.getDimensionPixelSize(R.styleable.RippleRelativeLayout_ripple_ripplePadding, 0);
        canvasHandler = new Handler();
        zoomScale = typedArray.getFloat(R.styleable.RippleRelativeLayout_ripple_zoomScale, 1.03f);
        zoomDuration = typedArray.getInt(R.styleable.RippleRelativeLayout_ripple_zoomDuration, 200);
        typedArray.recycle();
        paint = new Paint();
